...
class LidarDataset(Custom3DDataset):
    r"""Lidar Dataset contains only LIDAR data and bbox labels.
    Pointclouds and labels are in KITTI format (.bin files with RGBI values).
    ...
    # TODO: adapt from KITTI if needed
